      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="?page=problem"><?php lang("Problem");?></a></li>
                ...
                ?>
                      <tr>
                        ...
                        <button class="btn btn-danger btn-sm" data-toggle="modal"
                                  data-target="#modalDelete" data-id="<?php echo $row["id"];?>" data-name="<?php echo $row["name"];?>"><i class="fas fa-trash"></i></button>
                        <a href="apps/problem/do_problem.php?action=cancel_delete&id=<?php echo $row["id"];?>" class="btn btn-primary btn-sm" ><i class="fas fa-times"></i></a>
                        </td>
                      </tr>
                      <?php } ?>
