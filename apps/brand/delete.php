      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item "><a href="?page=brand"><?php lang("Brand");?></a></li>
                ...
                ?>
                      <tr>
                        ...
                        <button class="btn btn-danger btn-sm" data-toggle="modal"
                                  data-target="#modalDelete" data-brand-id="<?php echo $value["id"];?>" data-brand-name="<?php echo $value["name"];?>"><i class="fas fa-trash"></i></button>
                        <a href="apps/brand/do_brand.php?action=cancel_delete&brand_id=<?php echo $value["id"];?>" class="btn btn-primary btn-sm" ><i class="fas fa-times"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
