<?php
  ...
  $fields = "`id`,`username`, `email`, `first_name`, `last_name`, `gender`, `birthdate`, `phone_number`, `profile`, `position`, `is_active`, `updated_at`";
  $table = "users";
  $req = array(
          ...
          <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              ...
              <form id="upload-profile" action="apps/users/do_users.php?action=upload_profile&user_id=<?php echo $user["id"];?>" method="POST"
                ...
                <button type="submit" class="btn btn-primary btn-block btn-upload" disabled><b><?php lang("Upload");?></b></button>
              </form>
            </div>
            <!-- /.card-body -->
          </div>
                      ...
                      <div class="col-6 col-lg-2">
                        <div class="custom-control custom-radio my-2">
                          <input type="radio" id="enabled" name="is_active"
                            <?php if ($user["is_active"] == "Y") echo "checked"; ?> class="custom-control-input" value="Y">
                      ...
                      <div class="col-6 col-lg-2">
                        <div class="custom-control custom-radio my-2">
                          <input type="radio" id="disabled" name="is_active"
                            <?php if ($user["is_active"] == "N") echo "checked"; ?> class="custom-control-input" value="N">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="username" name="username"
                          value="<?php echo $user["username"];?>" placeholder="<?php lang("Username");?>" required>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="first_name" name="first_name"
                          value="<?php echo $user["first_name"];?>" placeholder="<?php lang("First Name");?>" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="last_name" name="last_name"
                          value="<?php echo $user["last_name"];?>" placeholder="<?php lang("Last Name");?>" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <select name="gender" id="gender" class="form-control">
                          <option value="M" <?php if ($user["gender"] == "M") echo "selected"; ?>><?php lang("Male");?></option>
                          <option value="F" <?php if ($user["gender"] == "F") echo "selected"; ?>><?php lang("Female");?></option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="date" class="form-control" id="birthdate" name="birthdate"
                          value="<?php echo $user["birthdate"];?>" placeholder="<?php lang("BirthDay");?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="tel" class="form-control" id="phone_number" name="phone_number"
                          value="<?php echo $user["phone_number"];?>" placeholder="<?php lang("Phone Number");?>">
                      </div>
                    </div>
                    <?php if ($_SESSION["POSITION"] == "1"){?>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <select name="position" id="position" class="form-control">
                          ...
                          foreach($position as $p_value){
                            $selected = "";
                            if($p_value["per_id"] == $user["position"]){ $selected = "selected"; }
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control"
                          value="<?php echo $position_txt[$user["position"]];?>" placeholder="Phone Number"
                          disabled>
                      </div>
                    </div>
                    <?php } ?>
